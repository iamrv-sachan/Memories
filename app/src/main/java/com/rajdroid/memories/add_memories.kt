...
class add_memories : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(toolbar_addMemories)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        toolbar_addMemories.setNavigationOnClickListener {
            onBackPressed()
        }
        ...
        addimage_memories.setOnClickListener(this)

        save_memory.setOnClickListener {
//            no_memories_text?.visibility = View.GONE;
    ...
    override fun onClick(v: View?) {
        ...
        {
            R.id.date -> {
                DatePickerDialog(this@add_memories,
                    dateSetListener,
            ...
            R.id.addimage_memories ->
            {
                ...
                picdialog.setItems(dialogItem)
                {
                    ...
                    when(which)
                    {
                        ...
                        1 -> {
                            Toast.makeText(this@add_memories, "selection of camera coming soon", Toast.LENGTH_SHORT).show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(resultCode == Activity.RESULT_OK)
        {
            if(requestCode == Camera)
            {
                ...
                image_memories.setImageBitmap(thumbnail)
            }
        }
        else if(resultCode == Activity.RESULT_OK)
        {
            if(requestCode == GALLERY)
            {
                if(data!=null)
                {
                    ...
                    image_memories.setImageBitmap(selectImageBitmap)
//                    try {
//
//                    }
//                    catch (e:IOException)
